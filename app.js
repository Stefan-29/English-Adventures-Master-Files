...
const App = {
    ...
    loadGrammarModules: function () {
        ...
        // THE SAME NAME.
        const moduleNames = ['can-could-be-able-to','must-have-to-have-got-to','shall-will-would-had-better','should-ought-to','may-might','future-perfect','future-tenses','past-perfect','past-tenses','present-perfect','present-tenses','conditional-structures','wish-if-if-only','if-alternatives','subjunctive-mood','gerund-vs-infinitive','after-certain-verbs','bare-infinitive']; // Add new ones here
