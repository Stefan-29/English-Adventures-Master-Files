// modules/grammarCheckers/countableVsUncountableNouns.js
export const countableVsUncountableNounsChecker = {
    ...
    check: function (text, activity) {
        ...
        return { status: 'ok', title: 'Good Job!', message: 'Your countable/uncountable noun usage looks correct!', icon: 'Checkmark' };
    }
};