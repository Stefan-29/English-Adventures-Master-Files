// modules/grammarCheckers/adjectivesAsNouns.js
export const adjectivesAsNounsChecker = {
    name: "Adjectives Used as Nouns",
    minWords: 10,
    check: function (text, activity) {
        ...
        return { status: 'ok', title: 'Good Job!', message: 'Your adjective-as-noun usage looks correct!', icon: 'Checkmark' };
    }
};