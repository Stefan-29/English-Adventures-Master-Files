// modules/grammarCheckers/everyoneVsEveryOne.js
export const everyoneVsEveryOneChecker = {
    name: "Everyone vs Every One",
    minWords: 10,
    check: function (text, activity) {
        ...
        return { status: 'ok', title: 'Good Job!', message: 'Your usage of everyone vs every one looks correct!', icon: 'Checkmark' };
    }
};